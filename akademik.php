                                ...
                                while ($row = $result->fetch_array()) { ?>
                                    ...
                                    <div class="col">
                                        <div class="row justify-content-end">
                                            ...
                                            <div class="col-xxl-12" style="padding-bottom: 7px;"><strong>Fakülte:</strong><span style="margin-left: 5px;" class='text-dark'><?php echo $row["personel_fakülte"]; ?></span></div>
                                            <div class="col-xxl-12" style="padding-bottom: 7px;"><strong>Ana Bilim Dalı:</strong><span style="margin-left: 5px;" class='text-dark'><?php echo $row["personel_bölüm"]; ?> </span></div>
                                            <div class="col-xxl-12" style="padding-bottom: 7px;"><strong>Ofis:</strong><span style="margin-left: 5px;" class='text-dark'><?php echo $row["personel_ofis"]; ?></span></div>
                                            <div class="col-xxl-12" style="padding-bottom: 7px;"><strong>Telefon:</strong><span style="margin-left: 5px;" class='text-dark'><?php echo $row["personel_telefon"]; ?></span></div>
                                            <div class="col-xxl-12" style="padding-bottom: 7px;"><strong>E-posta:</strong><span style="margin-left: 5px;" class='text-dark'><?php echo $row["personel_email"]; ?></span></div>
                                            <div class="col-xxl-12" style="padding-bottom: 7px;"><i class="fa fa-link fs-1"></i><a class="fs-5 text-dark" style="font-family:sans-serif;text-shadow:3px 3px 3px #9c9898;" href="<?php echo $row["personel_hakkında"]; ?>" target="_blank"><?php echo $row["personel_isim_soyisim"]; ?></a></div>
