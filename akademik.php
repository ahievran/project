                    ...
                    <div class="row" style="box-shadow: 0px 0px 7px var(--bs-gray-400);">
                        ...
                        <div class="col">
                            <div class="row justify-content-end">
                                ...
                                <div class="col-lg-auto offset-md-11 offset-lg-7 offset-xl-10 offset-xxl-10 text-center"><button class="btn btn-primary" type="button" data-bs-target="#modal-1" data-bs-toggle="modal">Video Mesajı</button></div>
                            </div>
                        </div>
                    </div>
