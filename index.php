...
include 'header.php'; ?>
    <main class="page landing-page">
        <section class="clean-block clean-hero"
            ...
            <div class="text">
                <h2 class='animate__animated animate__zoomInDown' id="bolum-uni-yazi">Kırşehir Ahi Evran Üniversitesi
                    Bilgisayar Mühendisliği</h2>
                <p class='animate__animated animate__zoomInUp' id="fak-ismi">Mühendislik Mimarlık Fakültesi</p><a
                        href="#hakkinda">
                    <button class="btn btn-outline-light animate__animated animate__fadeInDownBig" id="hakkimizda-buton"
                            type="button">Hakkımızda
                    </button>
                </a>
            </div>
        </section>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-4">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p class="">
                                            Üniversitemiz Erasmus programını desteklemektedir. Detaylı bilgi için
                                            Tıklayınız
                                        </p>
                                    </div>
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <div class="card">
                                    <a class="img-card"
                                       href="https://foreignaffairs.ahievran.edu.tr/icerik/farabidegisim">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p class="">
                                            Üniversitemiz Farabi programını desteklemektedir. Detaylı bilgi için
                                            Tıklayınız
                                        </p>
                                    </div>
                                    <div class="card-read-more btn-warning">
                            ...
                            <div class="col-xs-12 col-sm-4">
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <h4 class="card-title">
                                            <a href="https://foreignaffairs.ahievran.edu.tr/icerik/nedir">Mevlana
                                                Programı
                                            </a>
                                        </h4>
                                        <p class="">
                                            Üniversitemiz Mevlana programını desteklemektedir. Detaylı bilgi için
                                            Tıklayınız
                                        </p>
                                    </div>
                                    <div class="card-read-more btn-warning">
