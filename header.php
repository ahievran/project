...
<nav class="autohide navbar navbar-light navbar-expand-lg fixed-top clean-navbar" id="navbar">
    <div class="container-fluid">
        ...
        <div class="col-sm-3">
            <h1 class='animate__animated animate__fadeInBottomRight' id="logo-sag-yazi1">Mühendislik Mimarlık
                Fakültesi</h1>
            ...
            <ul class="navbar-nav ms-auto" id="ul">
                ...
                <li class="nav-item <?php if ($_SESSION["sayfa"] == 'what') {
                    echo 'active';
                        ...
                        echo 'active';
                    } ?>" href="https://drive.google.com/file/d/1Yb06Gk6EkdBtBqWi571LP36LchOooLb_/view" target="_blank">Ders
                        İçerikleri</a></li>
