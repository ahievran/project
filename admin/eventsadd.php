                        ...
                        <form method="POST" action="eventsadd.php" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ad" name="ad" placeholder="Etkinlik Başlığı Giriniz">
                                </div>
                                <div class="form-group">
                                    <label for="icerik">Etkinlik İçeriği</label>
                                    <input type="text" class="form-control" id="fakulte" name="icerik" placeholder="Etkinlik İçeriği Giriniz">
                                </div>
                                <div class="form-group">
