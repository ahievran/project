                ...
                <form method="POST" action="hedefadd.php">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" name="text1"
                                   placeholder="Hedefler Başlık Giriniz.">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Hedefler İçerik</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" name="text2"
                                   placeholder="Hedefler İçerik Giriniz.">
                        </div>
