                                    ...
                                    while ($row = $result->fetch_array()) { ?>
                                        <form method="post" action="labgoruntule.php">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="hidden" name="sil_id"
                                                           value="<?php echo $row["lab_id"]; ?>">
                                                    <input type="hidden" name="goruntulencek_resim"
                                                           value="<?php echo $row["lab_resim"]; ?>">
                                                    <input type="hidden" name="labAdi"
                                                           value="<?php echo $row["lab_ad"]; ?>">
                                                    <input type="hidden" name="labAciklama"
                                                           value="<?php echo $row["lab_aciklama"]; ?>">
                                        ...
                                        <form method="post" action="labs_sil.php">
                                            ...
                                            <td>
                                                <input type='hidden' value='<?php echo $row["lab_id"]; ?>'
                                                       name='silinecek_id'>
                                                <a>
